            ...
            <div className="containers">
                ...
                <div>
                    <form ALIGN="center" action="" id="form-id" className="form" onSubmit="return alert_confirmation()">
                        ...
                        <span className="input-group-text" id="basic-addon1">Tipo de producto</span>
                        ...
                        // className={boton}
                        ALIGN="center">
                            <button type="reset" id="botonVaciar" className="btn btn-ttc">Vaciar Formulario</button>
                            
                            <button type="submit" id="botonGuardar" className="btn btn-ttc" value="Submit" 
                            // onSubmit=Guardar()
                            >
                                Guardar</button>
                        </div>
